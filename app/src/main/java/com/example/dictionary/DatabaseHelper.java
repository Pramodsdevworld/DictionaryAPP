...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void openDataBase() throws SQLException {
        ...
        myDataBase.setMaximumSize(10 * 1024 * 1024);
    }
    ...
    public Cursor getMeaning(String text) {
        Cursor c = myDataBase.rawQuery("SELECT en_definition,example,synonyms,antonyms FROM words WHERE en_word==UPPER(?)", new String[]{text});
        return c;
    }
    ...
    public Cursor getSuggestions(String text) {
        ...
        if (c == null) {
            return new MatrixCursor(new String[]{"_id", "en_word"});
